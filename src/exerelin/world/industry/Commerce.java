...
public class Commerce extends IndustryClassGen {
	...
	public boolean canApply(ProcGenEntity entity) {
		// if (entity.numProductiveIndustries >=
		// NexMarketBuilder.getMaxProductiveIndustries(entity))
		// return false;
		// if (Misc.getNumIndustries(entity.market) >=
		// Misc.getMaxIndustries(entity.market))
		// return false;
